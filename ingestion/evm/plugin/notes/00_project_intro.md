...
Uses shared `ingestion/evm/rpc/storage` package:
...
- `ingestion/evm/rpc/storage` - PebbleDB storage, compactor
- `ingestion/evm/rpc/api` - Firehose WebSocket server
...
- vmID computed from "ingestion/evm/plugin" string
